...
my_fonttest = pygame.font.Font('Final_Fantasy_VII.ttf', 50)
...
while not done:
    ...
    if gamestate == 2:
        ...
        Enemeyr.set_enemy_hp(50)
        Player.set_player_hp(50, 50)
        ...
        #set button texts
        Button1 = my_fonttest.render('Fight', False, (0, 0, 0))
        screen.blit(Button1, (45, 361))
        Button2 = my_fonttest.render('Heal', False, (0, 0, 0))
        screen.blit(Button2, (45, 410))
        Button3 = my_fonttest.render('Defend', False, (0, 0, 0))
        screen.blit(Button3, (45, 455))
        Button4 = my_fonttest.render('Flee', False, (0, 0, 0))
        screen.blit(Button4, (45, 500))
        Health = my_fonttest.render('HP:' + str(Player.HP) + "/" + str(Player.MaxHP), False, (0, 0, 0))
        screen.blit(Health, (200, 365))
        MagicP = my_fonttest.render('MP:' + str(Player.MP) + "/" + str(Player.MaxMP), False, (0, 0, 0))
